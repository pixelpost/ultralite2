...
class EventTest extends \PHPUnit_Framework_TestCase
{
	...
	/**
	 * @covers pixelpost\Event::register
	 * @covers pixelpost\Event::signal
	 */
	...
	/**
	 * @covers pixelpost\Event::set_processed
	 * @covers pixelpost\Event::is_processed
	 */
